...
WebUI.comment('自動化テスト：法定会議システム　株主P35 起動')
...
//------------------------------------------------------------------------------------------------------------
'自動リマインド'
JvKOpt.autoRemind(C_Object.C_OFF)
...
WebUI.delay(8)
'提案書送付待ちへ'
JvUtil.clickElement(SK_Object.SK_提案書送付待ちへ, C_Object.C_可点击)
...
'提案書送付へ'
JvUtil.clickElement(SK_Object.SK_提案書送付, C_Object.C_可点击)
...
//------------------------------------------------------------------------------------------------------------
'同意 or 不同意'
String[] agreeList = [C_Object.C_不同意, C_Object.C_同意];
...
'否決報告'
JvKOpt.ReportBook(C_Object.C_否決報告);

//------------------------------------------------------------------------------------------------------------
// Page －＞　 （後続処理待ち）会議詳細
//------------------------------------------------------------------------------------------------------------
'否決完了ボタン'
JvUtil.clickElement(SK_Object.SK_否決完了ボタン)
'否決完了_いいえボタン'
JvUtil.clickElement(SK_Object.SK_否決完了_いいえボタン)
'否決完了ボタン'
JvUtil.clickElement(SK_Object.SK_否決完了ボタン)
'否決完了_はいボタン'
JvUtil.clickElement(SK_Object.SK_否決完了_はいボタン)
//------------------------------------------------------------------------------------------------------------
// Page －＞　 （否決）会議詳細
//------------------------------------------------------------------------------------------------------------

WebUI.comment('自動化テスト：法定会議システム　株主P35 終了')