...
WebUI.comment('自動化テスト：法定会議システム　書面P22 起動')
...
'議題追加'
JvOpt.taskInput(C_Object.C_初回_議題追加, "4")
...
'異議あり'
JvSOpt.allAgree(C_Object.C_監査役, C_Object.C_異議あり)
'不同意'
JvSOpt.allAgree(C_Object.C_取締役, C_Object.C_不同意)
...
'否決報告'
JvSOpt.ReportBook(C_Object.C_否決報告)
...
WebUI.comment('自動化テスト：法定会議システム　書面P22 終了')
