...
WebUI.comment('自動化テスト：法定会議システム　書面P27 起動')
...
//'確認書押印無しのチェック'
//JvSOpt.fileUploadCheck(C_Object.C_確認書押印無し)
//'同意書押印無しのチェック'
//JvSOpt.fileUploadCheck(C_Object.C_同意書押印無し)
...
//'確認書押印有りのチェック'
//JvSOpt.fileUploadCheck(C_Object.C_確認書押印有り)
//'同意書押印有りのチェック'
//JvSOpt.fileUploadCheck(C_Object.C_同意書押印有り)
...
WebUI.comment('自動化テスト：法定会議システム　書面P27 終了')
